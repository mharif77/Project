        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="col-sm-6 form-group ">
                ...
                <textarea name="street" id="" cols="30" rows="2" class="form-control"><?php echo isset($country) ? $country : '' ?></textarea>
              </div>
              <div class="col-sm-6 form-group ">
              ...
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Divison</label>
                <textarea name="city" id="" cols="30" rows="2" class="form-control"><?php echo isset($Divison) ? $Divison : '' ?></textarea>
              </div>
            </div>

           
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">zip_ode</label>
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Thana</label>
                <textarea name="country" id="" cols="30" rows="2" class="form-control"><?php echo isset($Thana) ? $Thana : '' ?></textarea>
              </div>
              <div class="col-sm-6 form-group ">
