...
<html lang="en">
    ...
    <body>
        ...
        <section class="page_banner" style="background-image: url(images/27.png);">
            <div class="container largeContainer">
                <div class="row">
            ...
            <div class="container largeContainer">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="subTitle"><span class="bleft"></span><span class="bright"></span></div>
                        <h2 class="secTitle">Our <span>Branches</span></h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="team_01 text-center">
                            ...
                            <h3><a href="single-team.html">Division</a></h3>
                            <p>Dhaka Branch</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
