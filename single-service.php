...
<html lang="en">
    <head>
        <title>Quera - Business & Finance Consultancy Responsive HTML5 Template</title>
        <meta charset="UTF-8">
    ...
    <body>
            ...
            <div class="container largeContainer">
                <div class="row">
                    <div class="col-lg-3 col-md-4">
                        <div class="logo">
                            <a href="index.php"><img src="" alt="Courier"></a>
                        </div>
                    </div>
                    <div class="col-lg-9 col-md-8">
                        <div class="topbar">
                            <p><i class="twi-bolt"></i>Need Help: Call 01679504643</p>
                            <div class="tpRight">
                        ...
                        <div class="navbar01">
                            ...
                            <ul>
                                    ...
                                    <li class="current-menu-item">
                                        <a href="our_branches.php">Our Branches</a>
                                       
                                    </li>
                                   
                                    </li>     
                                    <li class="current-menu-item">
                                        <a href="single-service.php">Services</a>
                            ...
                            <div class="accessNav">
                                ...
                                <a href="contact.html" class="qu_btn">Contact Us</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="page_banner" style="background-image: url(images/1.png);">
            <div class="container largeContainer">
                <div class="row">
                    <div class="col-md-4">
        ...
        <section class="aboutSection04">
            <div class="container largeContainer">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="abpd">
                            <div class="subTitle"><span class="bleft"></span>Welcome To Our Company</div>
                            <h2 class="secTitle">Build Your courier With Right Way</h2>
                            <p class="secDesc">
                                Accounting departments are usually responsible for keeping track of all purchase orders that have been placed for stock (products to be sold by the business) and all other assets and services.
                            </p>
                            <div class="hpAuthor">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="team_01 text-center">
                            ...
                            <h3><a href="single-team.html">Lara Maleon</a></h3>
                            <p>Managment</p>
                        </div>
                    </div>
        ...
        <!-- Why Choose Start -->
        <section class="chooseSection03 abcs01">
            <div class="container largeContainer">
                <div class="row">
            ...
            <div class="container largeContainer">
                <div class="row">
                    <div class="col-lg-7 col-md-6">
                        <h2 class="secTitle">Sign up for latest news and<br> insights from <span>Quera.</span></h2>
                    </div>
                    <div class="col-lg-5 col-md-6">
                        <div class="SubsrcribeForm">
                            <form class="yikes-easy-mc-form" action="#" method="post">
                                <input type="email" name="EMAIL" placeholder="Email Address">
                                <button class="yikes-easy-mc-submit-button" type="submit">Subsrcribe</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <div class="aboutWidget">
                            ...
                            <div class="phone"><i class="twi-phone"></i>01672162156</div>
                            <p>block:c road:2 East Bonosree BANGLADESH</p>
                            <a href="mailto:contact@example.com">arif@gmail.com</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
        ...
        <section class="fcopyright">
            <div class="container largeContainer">
                <div class="row">
                    <div class="col-md-6">
                        <p>© 2021 Quera. All Rights Reserved.</p>
                    </div>
                    <div class="col-md-6">
                        <div class="copyMenu">
                            <ul>
