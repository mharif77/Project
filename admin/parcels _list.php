...
<table class="table table-success table-striped" >
        ...
        while ($row = $data->fetch_assoc()) { ?>
            ...
            <tr>
                ...
                <td>
                <a href="edit_parchel.php?id=<?php echo $row['id'] ?>">Edit</a>
                    <a onclick="return confirm('Are you sure to delete')" href="parchels_delete.php?id=<?php echo $row['id'] ?>">Delete </a>
