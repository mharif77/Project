...
<head>
    ...
    <title>parcel_tracks  products</title>
</head>
...
<?php include "partial/left_bar.php" ?>
                    ...
                    <h3>parcel_tracks  list</h3>
    <?php
    $sql = "SELECT * FROM  parcel_tracks ";
    $data = $db->query($sql); ?>
...
<table class="table table-success table-striped" >
        ...
        while ($row = $data->fetch_assoc()) { ?>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_parcel_tracks.php?id=<?php echo $row['id'] ?>">Edit</a>
                    <a onclick="return confirm('Are you sure to delete')" href="parcel_tracks_delete.php?id=<?php echo $row['id'] ?>">Delete</a>
                </td>
            </tr>
